...
module.exports = {
  ...
  getAllArchiveSearch: function (req, res) {
    ...
    var data = [];
    c.query("SELECT `id`, `id`, `name`, `info`, `standard_level_id` FROM `archives` WHERE `id` LIKE ? OR `name` LIKE ? OR `year` LIKE ? OR `info` LIKE ?", request, { metadata: true, useArray: true }, function (err, rows) {
      if (err) {
        res.send({ message: err.message });
        console.log(err);
        return
    ...
    c.query("SELECT `id`, `id`, `name`, `publisher` FROM `dide` WHERE `id` LIKE ? OR `name` LIKE ? OR `publisher` LIKE ? OR `edition` LIKE ?", request, { metadata: true, useArray: true }, function (err, rows) {
      if (err) {
        res.send({ message: err.message });
        console.log(err);
        return
    ...
    c.query("SELECT `id`, `document_id`, `name`, `effective_date`, `standard_level_id` FROM `quality_documents` WHERE `id` LIKE ? OR `name` LIKE ? OR `effective_date` LIKE ?", request, { metadata: true, useArray: true }, function (err, rows) {
      if (err) {
        res.send({ message: err.message });
        console.log(err);
        return
    ...
    c.query("SELECT `id`, `id`, `name`, `form_id` FROM `quality_records` WHERE `id` LIKE ? OR `name` LIKE ? OR `form_id` LIKE ?", request, { metadata: true, useArray: true }, function (err, rows) {
      if (err) {
        res.send({ message: err.message });
        console.log(err);
        return
    ...
    c.query("SELECT `id`, `document_id`, `name`, `version` FROM `test_references` WHERE `id` LIKE ? OR `name` LIKE ?", request, { metadata: true, useArray: true }, function (err, rows) {
      if (err) {
        res.send({ message: err.message });
        console.log(err);
        return
    ...
    c.query("SELECT `id`, `id`, `company_name`, `device_name` FROM `test_reports` WHERE `id` LIKE ? OR `company_name` LIKE ? OR `device_name` LIKE ? OR `brand` LIKE ? OR `model` LIKE ?", request, { metadata: true, useArray: true }, function (err, rows) {
      if (err) {
        res.send({ message: err.message });
        console.log(err);
        return
    ...
    c.query("SELECT `id`, `id`, `name`, `trial_date` FROM `trial_reports` WHERE `id` LIKE ? OR `name` LIKE ? OR `trial_date` LIKE ? OR `num_device` LIKE ? OR `num_pass` LIKE ?", request, { metadata: true, useArray: true }, function (err, rows) {
      if (err) {
        res.send({ message: err.message });
        console.log(err);
        return
